 ...
 * @author dell
 */
public class PrintBill extends javax.swing.JInternalFrame implements globalvariables, Printable {
    ...
    public PrintBill() {
        ...
        id.setText(Bill.jComboBox1.getSelectedItem().toString().substring(Bill.jComboBox1.getSelectedItem().toString().lastIndexOf(",") + 1));
        bill.setText(Bill.jLabel3.getText());
        date.setText(Bill.jLabel5.getText());
        time.setText(Bill.jLabel7.getText());
        name.setText(Bill.jLabel17.getText());
        roomno.setText(Bill.jLabel9.getText());
        type.setText(Bill.jLabel11.getText());
        SimpleDateFormat myformat = new SimpleDateFormat("dd-MM-yyyy");
        arrival.setText(myformat.format(Bill.jDateChooser1.getDate()));
        departure.setText(myformat.format(Bill.jDateChooser2.getDate()));

        jTable1.setValueAt(Bill.perday, 0, 1);
        jTable1.setValueAt(Bill.days, 0, 2);
        jTable1.setValueAt(Bill.rate, 0, 3);
        jTable1.setValueAt(Bill.tax, 1, 3);
        jTable1.setValueAt(Bill.charge, 2, 3);
        jTable1.setValueAt(Bill.total, 7, 3);
